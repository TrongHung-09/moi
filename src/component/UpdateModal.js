...
const UpdateModal = (props) => {
    ...
    const { listProduct, setListProduct, listBrand, listSubCategories, listStatus, show, id } = props
    ...
    const detail = async () => {
        ...
        setProduct(res.data)
        console.log('>>>>>CHECK PRODUCe', res.data)
    }
    ...
    return (
        <>
            <Button onClick={setShowModal} className="btn-warning">Edit</Button>
